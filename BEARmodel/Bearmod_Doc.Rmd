...
######################
X4 <- 4941509 - (results$X1+results$X2+results$X3)
par(mfrow=c(2,2))
plot(results$X1~as.Date(results$dates,"%y/%m/%d"),
      type='p',col="blue",ylab="X1", xlab="Date")
plot(results$X2~as.Date(results$dates,"%y/%m/%d"),
      type='p',col="blue",ylab="X2", xlab="Date")
plot(results$X3~as.Date(results$dates,"%y/%m/%d"),
      type='p',col="blue",ylab="X3", xlab="Date")
plot(X4~as.Date(results$dates,"%y/%m/%d"),
     type='p',col="blue",ylab="S", xlab="Date")
```
